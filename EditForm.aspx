<%@ Page Language="C#" Inherits="IEPDEMO.EditForm" Debug="true" CodeFile="Businesslogic/EditForm.aspx.cs" %>
<!DOCTYPE html>
    <html>
        <head>
            <title>
        ...
        <body>
            <form runat="server">
                ...
                <input type="submit" id="Submitbtn" runat="server" onserverclick="Editdetails">
